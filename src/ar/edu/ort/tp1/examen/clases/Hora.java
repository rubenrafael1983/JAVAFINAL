...
public class Hora {
	 ...
	 * @param otraHora
	 * @param minutoSalida
	 * @return la cantidad de horas y minutos de diferencia entre la hora this y la pasada por parámetro
	 */
	...
	/**
	 * Compara la hora this con la recibida por parámetro, si la recibida por parámetro es anterior, devuelv <code>true</code>
	 * @param hora a comparar
	 * @return <code>true</code> si la hora recibida por parámetro es anterior a this, <code>false</code> en cualquier otro caso.
	 */
	...
	// TODO A completar
	/**
	 * Indica si la hora es válida (en base a los valores de hora y minuto)
	 * @return
	 */
